...
import {ChainId, Token, WETH} from "@godtoy/pancakeswap-sdk-v2";
...
config.ROUTE_ADDRESS = ROUTES[config.ROUTE_SWAP_CHOOSE as 'pancakeswap' | 'BakerySwap']
...
//BSC chain
export const WBNB = WETH[config.chainId as 56 | 97];
